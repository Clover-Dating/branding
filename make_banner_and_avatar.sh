...
magick banner-grass-1x.png -filter point -resize 1500% \
  -gravity center -crop 1500x500+0+0 +repage banner-grass.png
echo "Created banner-grass.png (1500x500)"

# Twitter avatar: 400x400
# Calculate minimum scale factor so both dimensions >= 400px
read width height <<< $(magick identify -format "%w %h" avatar-1x.png)
...
magick avatar-1x.png -filter point -resize ${percent}% \
